...
#### Problem
Discord bot and worker used `sb_secret_<REDACTED>` format key, but heartbeat kept getting "Invalid API key" errors.
...
```
<REDACTED-ROTATE-VIA-SUPABASE-DASHBOARD-ref-juaekekwvcuyeleyvrvc>
```
...
**Frasier Tweets (legacy VoxYZ links):**
